...
public interface MmbPointRecordMapperExt {
    ...
    //检索两年前需要清空的积分
    List<MmbPointRecordExt> countSubPointOneTime(Date pointTime);
    ...
    int clearSubPointOneTime(Date pointTime);
    ...
    List<MmbPointRecord> selectByMemberIdYear(String memberId);
}
