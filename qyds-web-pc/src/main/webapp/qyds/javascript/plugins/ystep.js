  ...
  $.fn.extend({
    ...
    loadStep: function(params){
      ...
      var baseHtml =  "<div class='ystep-container'>"+
                      ...
                      "</div>";
      //步骤框架
      var stepHtml = "<li style='position:relative;' class='ystep-step ystep-step-undone' data-container='body' data-toggle='popover' data-placement='top' data-title='' data-content='' data-trigger='hover'>"+
                     "</li>";
      //决策器
      var logic = {
        size: {
      ...
      $(this).each(function(i,n){
        ...
        for(i=0;i<arrayLength;i++){
          ...
          //if(_s.cb){
          //  var stepFunc = _s.cb;
          //  $stepHtml.html('<div class="title">'+_s.title+'</div><div class="stepTag">'+_s.stepTag+'</div><div class="time">'+_s.time+'</div>');
          //}else{
          //  $stepHtml.html('<div class="title">'+_s.title+'</div><div class="stepTag">'+_s.stepTag+'</div><div class="time">'+_s.time+'</div>');
          //}
          $stepHtml.html('<div class="title">'+_s.title+'</div><div class="stepTag">'+_s.stepTag+'</div><div class="time">'+_s.time+'</div>');
        ...
        // add by sunt start
        $($n).find('.stepTag').click(function(){
          var clickIndex = $(this).parent().index();
          var step = params.steps[clickIndex];
          if(step.cb){
            if (step.cb(clickIndex)){
              $n.setStep(clickIndex + 1);
            }
            return false;
          }else if(params.clickCb){
            if(params.clickCb(clickIndex)){
              $n.setStep(clickIndex + 1);
            }
            return false;
          }
