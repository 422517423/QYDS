...
; (function ($) { 
    $.fn.jqLoading =function(option) {
        var defaultVal = {
            ...
            backgroundImage: "css/images/loading.gif",//背景图片
            text: "加载中...",//文字
            width: 150,//宽度
            height: 60,//高度
            type:0 //0全部遮，1 局部遮
        ...
        function openLayer() {
           ...
           //图片及文字层
            ...
            content.append("<img style='width:30px;height:30px;vertical-align:middle;margin:"+(opt.height/4)+"px; 0 0 5px;margin-right:5px;' src='" + opt.backgroundImage + "' /><span style='text-align:center; vertical-align:middle;margin-left: 10px'>" + opt.text + "</span>");
