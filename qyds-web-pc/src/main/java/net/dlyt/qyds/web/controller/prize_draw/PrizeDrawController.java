...
//    }
     ...
     * 获取会员的抽奖记录
     *
     * @param data memberId-用户ID;分页信息
     * @return
     */
    @RequestMapping("getMemberPrizeList")
    @ResponseBody
    public JSONObject getMemberPrizeList(String data) {
        PrizeDrawOppoExt form = (PrizeDrawOppoExt) JSON.parseObject(data, PrizeDrawOppoExt.class);
        return prizeDrawService.getMemberPrizeList(form);
    }
