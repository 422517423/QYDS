 ...
 */
@Controller
@RequestMapping("/gds_master_pc_api")
public class GdsMasterPCApiController {
    ...
    @RequestMapping("getMatingListAndRecommendList")
    @ResponseBody
    public JSONObject getMatingListAndRecommendList(String data) {
        return gdsMasterService.getMatingListAndRecommendList(data);
    }
...
//        return gdsMasterService.getProductListByActivityId(data);
     ...
     * @return
     */
    @RequestMapping("getProductListByActivityIds")
    @ResponseBody
    public JSONObject getProductListByActivityIds(String data) {
        ...
        gdsMasterExt.setMemberId(null);
        data = JSON.toJSON(gdsMasterExt).toString();
        JSONObject jsonObject =  gdsMasterService.getProductListByActivityIds(data);
...
//        return gdsMasterService.getProductListByActivityId(data);
    ...
    public JSONObject goodsOrder(String data) {
        return gdsMasterService.goodsOrder(data);
    }
     ...
     * @return
     */
    @RequestMapping("activitysListService")
    @ResponseBody
    public JSONObject activitysListService(String data) {
        return gdsMasterService.activitysListService(data);
    }
