...
public class EncryptUtil {
	...
	* @throws
	...
	public static final String encrypt1(String password) throws Exception {
		...
		System.out.println("password to byte[]：");
...
for (int i = 0;i<a.length;i++){
	System.out.println(i+"：" + a[i]);
		...
		BigInteger bi_passwd = new BigInteger(a);//UTF-8"));
		...
		System.out.println("bi_r1 to String：" + bi_r1.toString(RADIX));
...
//		System.out.println("123456789转16进制：" + (new BigInteger("123456789").toString(RADIX)));
//		System.out.println("12345678901234567890：" + "12345678901234567890".getBytes());
//		System.out.println("12345678901234567890：" + encrypt("12345678901234567890你"));
//		System.out.println("zyxwvutsrqponmlkgihgfedcba：" + encrypt1("zyxwvutsrqponmlkgihgfedcba"));
//		System.out.println("zyxwvutsrqponmlkgihgfedcba："+ getErpKey("zyxwvutsrqponmlkgihgfedcba"));
//		System.out.println("测试验证Key："+ getErpKey("测试验证Key"));
//		System.out.println("zyxwvutsrqponmlkgihgfedcba的MD5："+EncryptUtil.encodeMD5("zyxwvutsrqponmlkgihgfedcba"));
