...
angular.module('test', ['ionic', 'test.controllers', 'test.filter','test.routes','test.directive',
    'test.services','ionic-datepicker'
])
...
.run(function($ionicPlatform, $http, $rootScope,$ionicHistory,$state,
    ...
    $rootScope.setTitle = function(title){
        ...
        var $iframe = $jq("<iframe style='display:none;' src=''></iframe>");
