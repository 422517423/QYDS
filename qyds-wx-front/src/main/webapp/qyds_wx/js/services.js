angular.module('dealnua.services', [])
    ...
    .factory("prizeDrawService", function($http,$q) {
        function prizeDrawService(param) {
            function getPrizeDrawById() {
                var defer = $q.defer();
                $http.post("../prize_draw/getPrizeDrawInfo.json", $jq.param({'data': JSON.stringify(param)}))
                    .then(
                        function (response) {
                            defer.resolve(response.data);
                        }, function () {
            ...
            function exchangePrizeWithPoint() {
                var defer = $q.defer();
                $http.post("../prize_draw/exchangePrizeWithPoint.json", $jq.param({'data': JSON.stringify(param)}))
                    .then(
                        function (response) {
                            defer.resolve(response.data);
                        }, function () {
            ...
            function getWinningList() {
                var defer = $q.defer();
                $http.post("../prize_draw/getWinningList.json", $jq.param({'data': JSON.stringify(param)}))
                    .then(
                        function (response) {
                            defer.resolve(response.data);
                        }, function () {
            ...
            function getPrizeGoodsList() {
                var defer = $q.defer();
                $http.post("../prize_draw/getPrizeGoodsList.json", $jq.param({'data': JSON.stringify(param)}))
                    .then(
                        function (response) {
                            defer.resolve(response.data);
                        }, function () {
            ...
            function prizeDraw() {
                var defer = $q.defer();
                $http.post("../prize_draw/prizeDraw.json", $jq.param({'data': JSON.stringify(param)}))
                    .then(
                        function (response) {
                            defer.resolve(response.data);
                        }, function () {
    ...
    .factory("activityTypeListService", function($http,$q) {
        ...
        function getData(params) { //<———————需要给原来的方法体做一个内部方法名字尽量起的有意义（getxxx、savexxxx等）
            ...
            json.memberId = memberId;
            $http.post("../gds_master_api/activityTypeListService.json",$jq.param({'data':JSON.stringify(json)})).then(
                function(response) {
                    defer.resolve(response.data);
                },function(){
                    defer.reject();
    ...
    .factory("getAlltypesService",["$q","$http", function($q, $http) {
        function getTypeData(param) {
            var defer = $q.defer();
            $http.post("../gds_type_api/getAllTypes.json", $jq.param({}))
                .then(
                    function(response) {
                        defer.resolve(response.data);
                    },function(){
    ...
    .factory("brandtypeService",["$q","$http", function($q, $http) {
        function getTypeData(param) {
            var defer = $q.defer();
            var json;
            $http.post("../gds_type_api/getGdsBrandTypeFloor.json")
                .then(
                    function(response) {
                        defer.resolve(response.data);
                    },function(){
    ...
    .factory("confirmOrderService", function($http,$q) {
        function confirmOrderService(param) {
            ...
            function checkDataByBag() {
                var defer = $q.defer();
                $http.post("../ord_wechat/checkConfirmOrderFromBag.json", $jq.param({'data': JSON.stringify(param)}))
                    .then(
                        function (response) {
                            defer.resolve(response.data);
                        }, function () {
            ...
            function checkDataBySingleGoods() {
                var defer = $q.defer();
                $http.post("../ord_wechat/checkConfirmOrderFromGoods.json", $jq.param({'data': JSON.stringify(param)}))
                    .then(
                        function (response) {
                            defer.resolve(response.data);
                        }, function () {
    ...
    .factory("secKillService",  ["$q","$http",function($q,$http) {
        ...
        function secKillService(param) {
            ...
            function getTimes() {
                var defer = $q.defer();
                $http.post("../gds_master_api/getSecKillActivityTimes.json", $jq.param({'data':JSON.stringify(param)}),{noLoading:true}).then(
                    function (response) {
                        defer.resolve(response.data);
                    }, function () {
                        defer.reject();
            ...
            function getProducts() {
                var defer = $q.defer();
                $http.post("../gds_master_api/getSecKillProductList.json", $jq.param({'data':JSON.stringify(param)})).then(
                    function (response) {
                        defer.resolve(response.data);
                    }, function () {
                        defer.reject();
