...
public class MmbMaster implements Serializable {
    ...
    public String getRegistStyle() {
        return registStyle;
    }

    public void setRegistStyle(String registStyle) {
        this.registStyle = registStyle == null ? null : registStyle.trim();
    }
    ...
    public String getErpSendCancleStatus() {
        return erpSendCancleStatus;
    }

    public void setErpSendCancleStatus(String erpSendCancleStatus) {
        this.erpSendCancleStatus = erpSendCancleStatus == null ? null : erpSendCancleStatus.trim();
    }
    ...
    public void setUnUsedTime(String unUsedTime) {
        this.unUsedTime = unUsedTime == null ? null : unUsedTime.trim();
    }
}