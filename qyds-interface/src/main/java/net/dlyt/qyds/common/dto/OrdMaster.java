...
public class OrdMaster implements Serializable {
    ...
    //店员扫码的id
    private String memberIdForWx;

    public String getMemberIdForWx() {
        return memberIdForWx;
    }

    public void setMemberIdForWx(String memberIdForWx) {
        this.memberIdForWx = memberIdForWx;
    }
