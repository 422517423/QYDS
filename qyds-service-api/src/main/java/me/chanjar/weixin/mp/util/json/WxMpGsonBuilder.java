...
public class WxMpGsonBuilder {
  ...
  static {
    ...
    INSTANCE.registerTypeAdapter(WxMpUserBatchGet.class, new WxMpUserBatchGetGsonAdapter());
    INSTANCE.registerTypeAdapter(WxMpUserBatchGet.WxMpUserBatchGetItem.class, new WxMpUserBatchGetItemGsonAdapter());
    INSTANCE.registerTypeAdapter(WxMpUserBatchGetResult.class, new WxMpUserBatchGetResultGsonAdapter());
  }
