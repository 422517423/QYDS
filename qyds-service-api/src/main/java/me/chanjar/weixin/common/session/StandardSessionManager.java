...
public class StandardSessionManager implements WxSessionManager, InternalSessionManager {
  ...
  public void processExpires() {
    ...
    if(log.isDebugEnabled())
      log.debug("Start expire sessions {} at {} sessioncount {}", timeNow, sessions.length);
    ...
    if(log.isDebugEnabled())
      log.debug("End expire sessions {} processingTime {} expired sessions: {}", timeEnd - timeNow, expireHere);
