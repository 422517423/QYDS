...
//                            || Integer.valueOf(goodsInfoMap.get("safe_bank").toString()) < Integer.valueOf(goodsInfoMap.get("new_count").toString())
    ...
    public OrdMaster submitOrder(OrdMasterExt ordMasterExt) throws Exception {
        ...
        if (ordMasterExt.getMemberIdForWx()!=null&&ordMasterExt.getMemberIdForWx().contains("memberIdForWx")) {
...
//        }
    ...
    private String orderStatusNameGet(String orderStatus, String payStatus, String deliverStatus) {
        ...
        if ("10".equals(orderStatus) && "10".equals(deliverStatus) && "10".equals(payStatus)) {
            ...
            result = "申请退款中";
        } else if ("10".equals(orderStatus) && "27".equals(deliverStatus) && "20".equals(payStatus)) {
            result = "调货已分派";
        } else if (("10".equals(orderStatus) || "23".equals(orderStatus)) && ("20".equals(deliverStatus) || "19".equals(deliverStatus)) && "20".equals(payStatus)) {
            result = "待收货";
        } else if (("10".equals(orderStatus) || "23".equals(orderStatus)) && "18".equals(deliverStatus) && "20".equals(payStatus)) {
            result = "拒绝订单发货";
            ...
            result = "退货完成";
        } else if ("10".equals(orderStatus) && "15".equals(deliverStatus) && "20".equals(payStatus)) {
            result = "申请调货";
        } else if ("10".equals(orderStatus) && "35".equals(deliverStatus) && "20".equals(payStatus)) {
            result = "调货完成";
        } else if ("10".equals(orderStatus) && "36".equals(deliverStatus) && "20".equals(payStatus)) {
            result = "取消分派";
        } else if ("10".equals(orderStatus) && "37".equals(deliverStatus) && "20".equals(payStatus)) {
            result = "拒绝分派";
        } else if ("10".equals(orderStatus) && "39".equals(deliverStatus) && "20".equals(payStatus)) {
            result = "调货分派";
        } else if ("10".equals(orderStatus) && "33".equals(deliverStatus) && "20".equals(payStatus)) {
            result = "接受分派";
        } else if ("10".equals(orderStatus) && "43".equals(deliverStatus) && "20".equals(payStatus)) {
            result = "申请调货";
        } else if ("10".equals(orderStatus) && "40".equals(deliverStatus) && "20".equals(payStatus)) {
            result = "调货发货";
        } else if ("10".equals(orderStatus) && "41".equals(deliverStatus) && "20".equals(payStatus)) {
            result = "调货收货";
        } else if ("10".equals(orderStatus) && "50".equals(deliverStatus) && "20".equals(payStatus)) {
            result = "门店发货";
        } else if ("10".equals(orderStatus) && "69".equals(deliverStatus) && "20".equals(payStatus)) {
            result = "分派门店";
        } else if ("10".equals(orderStatus) && "88".equals(deliverStatus) && "20".equals(payStatus)) {
            result = "修改自提门店";
        } else {
    ...
    public JSONObject returnGoodsReceive(OrdReturnExchangeExt ordReturnExchange) {
        ...
        try {
            ...
            //退货的时候，需要减去销量，更新销量值（完成）
            String goodsId = ordSubList.getGoodsId();
