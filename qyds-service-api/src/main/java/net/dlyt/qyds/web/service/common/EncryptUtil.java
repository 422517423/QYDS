...
public class EncryptUtil {
	...
	* @throws
	...
	public static void main(String[] args) throws Exception{
        ...
        String  s = "bb5683c5-7916-4e79-9dd6-d2292530871a";
        String  s1  = "2a9d1da4-7d98-4ea1-bd0c-6a8e0368f05915541164806孙1299.001299.002018-01-22 16:47:16100.00101010088025";
...
//		System.out.println("加密前：" + contents);
		...
		String s2 = EncryptUtil.encodeMD5(s+s1);
		System.out.println("md5加密后----："+s2);
		String encrypt = EncryptUtil.encrypt(s2);
		System.out.println("异或后----："+encrypt);
