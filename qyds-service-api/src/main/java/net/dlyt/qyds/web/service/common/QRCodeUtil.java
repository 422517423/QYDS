...
public final class QRCodeUtil extends LuminanceSource {
    ...
    /**
     * 通过店员id生成二维码，保存在/mnt/tomcat/qyds_file/qyds下
     * 文件名是“店员id.png”
     *
     * @param salerId   店员id
     * @return  返回文件的路径
     */
    public static String getCodeForSaler(String salerId){
        String textStart = "https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx38bf661fefcdc9b5&redirect_uri=https%3A%2F%2Fwww.dealuna.com%2Fqyds-wx-front%2Fqyds_wx%2Findex.html%3fmemberIdForWx%3d"; // 随机生成验证码
        String textEnd= "&response_type=code&scope=snsapi_base";
        String text = textStart + salerId + textEnd;
...
//            //正式
            String savedPath = fileServerConfig.getStoragePath() + "orignal/SALER_IMG/";
            //本地测试
//            String savedPath = "D:/img/";
            String fileName =  salerId + ".png" ;
            String pathName = generateQRCode(text, width, height, format, savedPath+fileName);
            String pathForDatabase = "/SALER_IMG/"+fileName;
    ...
    public static void main(String[] args) {
        String salerId = "a999999999999a";
        String textStart = "https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx38bf661fefcdc9b5&redirect_uri=https%3A%2F%2Fwww.dealuna.com%2Fqyds-wx-front%2Fqyds_wx%2Findex.html%3fmemberIdForWx%3d"; // 随机生成验证码
        String textEnd= "&response_type=code&scope=snsapi_base";
        String text = textStart + salerId + textEnd;
//        String text = "https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx38bf661fefcdc9b5&redirect_uri=https%3A%2F%2Fwww.dealuna.com%2Fqyds-wx-front%2Fqyds_wx%2Findex.html&response_type=code&scope=snsapi_base"; // 随机生成验证码
        System.out.println("随机码： " + text);
        int width = 150; // 二维码图片的宽
        int height = 150; // 二维码图片的高
        String format = "png"; // 二维码图片的格式
