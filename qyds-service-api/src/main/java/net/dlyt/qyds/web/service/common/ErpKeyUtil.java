...
//        saleMaster.setStoreName(changStringNull(saleMaster.getStoreName()));
        ...
        saleMaster.setCouponMemberId(changStringNull(saleMaster.getCouponMemberId()));
        saleMaster.setWorth(changStringNull(saleMaster.getWorth()));
        ...
        key += saleMaster.getCouponMemberId();
        key += saleMaster.getWorth();
...
//        System.out.println(EncryptUtil.encodeMD5(ERP_TOKEN_KEY + data.toLowerCase()).toString());
        String s = EncryptUtil.encodeMD5(ERP_TOKEN_KEY+ data.toLowerCase());
        String s1 =EncryptUtil.encrypt(s);
        return s1;
    }
