window.Gantt = {
    ...
    t = {
        ...
        t.mixin(t.config, {
            ...
            i = i || t, this.config[t] && n[i] != this.config[t] && (e && this.templates[i] || (this.templates[i] = this.date.date_to_str(this.config[t]), n[i] = this.config[t])), this._reg_templates = n
        ...
        initEventAccessor: function() {
            ...
            this.eventAccessor = function(t) {
                return t
            }, t.config.touch && (window.navigator.msPointerEnabled ? (e.move = "MSPointerMove", e.down = "MSPointerDown", e.up = "MSPointerUp", this.eventAccessor = function(t) {
            ...
            if (n) {
                if (!this.config.marker && !this.config.started) {
                    ...
                    if (t.config.touch || this.checkPositionChange(a)) {
                        if (this.config.started = !0, this.config.ignore = !1, this.callEvent("onBeforeDragStart", [e, this.config.original_target]) === !1) return this.config.ignore = !0, !0;
        ...
        for (var i = this.getGridColumns(), n = [], a = 0; a < i.length; a++) {
            var s, r, o = a == i.length - 1,
                _ = i[a];
            "add" == _.name ? r = "<div class='gantt_add'></div>" : (r = _.template ? _.template(e) : e[_.name], r instanceof Date && (r = this.templates.date_grid(r, e)), r = "<div class='gantt_tree_content'>" + r + "</div>");
            ...
            this.defined(_.align) && (u += "text-align:" + _.align + ";"), s = "<div class='" + d + "' style='" + u + "'>" + l + r + "</div>", n.push(s)
        }
        ...
        return f.className = "gantt_row" + d, f.style.height = this.config.row_height + "px", f.style.lineHeight = t.config.row_height + "px", f.setAttribute(this.config.task_attribute, e.id), f.innerHTML = n.join(""), f
    }, t.open = function(e) {
        ...
        if (e != n) {
            ...
            if (this.callEvent("onBeforeTaskMove", [e, n, i]) !== !1) {
                ...
                var d = o[i];
                d ? o = o.slice(0, i).concat([e]).concat(o.slice(i)) : o.push(e), this.setParent(s, n), this._branches[n] = o;
                var l = this.calculateTaskLevel(s) - s.$level;
                s.$level += l;
                for (var h = this._getTaskTree(e), c = 0; c < h.length; c++) {
                    var u = this._pull[h[c]];
                    u.$level += l
                }
                1 * i > 0 ? a ? s.$drop_target = (this.getTaskIndex(e) > this.getTaskIndex(a) ? "next:" : "") + a : s.$drop_target = "next:" + t.getPrevSibling(e) : o[1 * i + 1] ? s.$drop_target = o[1 * i + 1] : s.$drop_target = n, this.callEvent("onAfterTaskMove", [e, n, i]) && this.refreshData()
            }
        }
        ...
        this.defined(this.config.dnd_sensitivity) && (e.config.sensitivity = this.config.dnd_sensitivity), e.attachEvent("onBeforeDragStart", this.bind(function(i, n) {
            ...
            if (this.isTaskExists(h) || (h = e.lastTaskOfLevel(t.config.order_branch_free ? c.$level : 0), h == e.config.id && (h = null)), this.isTaskExists(h)) {
                ...
                if (u.y + l.offsetHeight / 2 < o) {
                    ...
                    if (p) {
                        if (p.id == c.id) return this.config.order_branch_free && this.isChildOf(c.id, g.id) && 1 == this.getChildren(g.id).length ? void this.moveTask(c.id, this.getTaskIndex(g.id) + 1, this.getParent(g.id)) : void 0;
                        g = p
                    } else if (p = this._pull[this._order[f]], a(p, c) && p.id != c.id) return void this.moveTask(c.id, -1, this.getParent(p.id))
                } else if (this.config.order_branch_free && g.id != c.id && a(g, c)) {
                    if (!this.hasChild(g.id)) return void this.moveTask(c.id, -1, g.id);
                    if (this.getGlobalTaskIndex(g.id)) return
                }
        ...
        column_drag_move: t.bind(function(e, i, n) {
            ...
            return _ > o && (o = _), this.config.keep_grid_width && o > d && (o = d), h = o - l, a.marker.style.top = r.y + "px", a.marker.style.left = r.x - 1 + l + "px", a.marker.style.width = h + "px", a.left = o - 1, t.callEvent("onColumnResize", [a.drag_index, s[a.drag_index], h - 1]), !0
        }, t),
        column_drag_end: t.bind(function(e, i, n) {
            ...
            if (t.callEvent("onColumnResizeEnd", [r, o, d]) !== !1 && o.width != d) {
                if (o.width = d, this.config.keep_grid_width) for (var _ = r + 1, l = a.length; l > _; _++)"add" == a[_].name ? a[_].width = 1 * a[_].width || 44 : a[_].width = null;
                else {
        ...
        container_drag_move: t.bind(function(e, i, n) {
            for (var a = e.config, s = this.config.columns, r = this._get_position(this.$grid), o = parseInt(a.marker.style.left, 10), _ = 0, d = 0; d < s.length; d++) s[d].hide || (_ += s[d].min_width ? s[d].min_width : this.config.min_grid_column_width);
        ...
        container_drag_end: t.bind(function(e, i, n) {
            ...
            for (var d = a.length, l = r - s, h = 0, o = 0; d > o; o++) if (!a[o].hide) {
                var c = Math.floor(l * (a[o].width / s));
                s -= a[o].width, h = a[o].width + c, (a[o].min_width && h >= a[o].min_width || !a[o].min_width || h > a[o].width) && (l -= c, a[o].width = h)
            }
            for (var u = l > 0 ? 1 : -1; l > 0 && 1 === u || 0 > l && -1 === u;) {
                var g = l;
                for (o = 0; d > o; o++) {
                    var f = a[o].width + u;
                    if ((a[o].min_width && f >= a[o].min_width || !a[o].min_width || h > a[o].width) && (l -= u, a[o].width = f, !l)) break
                }
                if (g == l) break
            }
        ...
        if (t.config.branch_loading && t._load_url) {
            ...
            if (!i && t._has_children(e) && !t.getChildren()) return !0
        }
        return !1
        ...
        if (t.config.branch_loading && t._load_url && t._need_dynamic_loading(e)) {
            ...
            var n = i.indexOf("?") >= 0 ? "&" : "?",
                a = 0;
            this._cached_scroll_pos && this._cached_scroll_pos.y && (a = Math.max(this._cached_scroll_pos.y, 0)), t.load(i + n + "parent_id=" + encodeURIComponent(e), this._load_type, function() {
                a && t.scrollTo(null, a)
        ...
        _ignore_time_config: function(t, e) {
            return this.config.skip_off_time ? !this.isWorkTime(t, e || void 0) : !1
        },
        ...
        iterateScales: function(t, e, i, n, a) {
            for (var s = e.trace_x, r = t.trace_x, o = i || 0, _ = n || r.length - 1, d = 0, l = 1; l < s.length; l++) {
                var h = t.trace_indexes[+s[l]];
                void 0 !== h && _ >= h && (a && a.apply(this, [d, l, o, h]), o = h, d = l)
            }
        },
        ...
        if (e.ignore_x = {}, t.ignore_time || t.config.skip_off_time) {
            ...
            i = 0;
            for (var a = t.getState().scale_unit, s = 0; s < e.trace_x.length; s++) n.call(t, e.trace_x[s]) || this._ignore_time_config.call(t, e.trace_x[s], a) ? (e.ignore_x[e.trace_x[s].valueOf()] = !0, e.ignored_colls = !0) : i++
        }
        e.display_count = i
    }, t._tasks_dnd = {
        drag: null,
        ...
        render_line: function(t) {
            ...
            i.style.cssText = ["top:" + e.top + "px", "left:" + e.left + "px", "height:" + e.height + "px", "width:" + e.width + "px"].join(";"), i.className = "gantt_line_wrapper";
        ...
        get_points: function(e) {
            ...
            else if (e.type == t.config.links.finish_to_start) if (_ = i.e_x > i.x + 2 * o, this.point_to(r.right, o), _) s -= o, this.point_to(r.down, a), this.point_to(r.right, s);
            else {
                s -= 2 * o;
                var d = a > 0 ? 1 : -1;
            ...
            else if (e.type == t.config.links.start_to_finish) if (_ = i.e_x > i.x - 2 * o, this.point_to(r.left, o), _) {
                s += 2 * o;
                var d = a > 0 ? 1 : -1;
        ...
        function d() {
            return h._direction || (h._direction = document.createElement("div"), t.$task_links.appendChild(h._direction)), h._direction
        }
        function l() {
        ...
        h.attachEvent("onBeforeDragStart", t.bind(function(i, n) {
            ...
            s(), this.config.touch ? (this._show_link_points = !1, this.refreshData()) : (e.from && t.refreshTask(e.from, !1), e.to && t.refreshTask(e.to, !1)), l()
        ...
        this.callEvent("onBeforeDataRender", []), this._order_synced ? this._order_synced = !1 : this._sync_order(), this._update_layout_sizes(), this._scroll_resize();
        ...
        var i = [],
            ...
            a = null,
            s = null;
        (e.template || e.date) && (a = e.template || this.date.date_to_str(e.date)), s = e.css ||
            function() {}, !e.css && this.config.inherit_scale_class && (s = t.templates.scale_cell_class);
        ...
        if (!this._isAllowedUnscheduledTask(e)) {
            ...
            (e.color || e.progressColor || e.textColor) && (l += " gantt_task_inline_color"), r.className = l;
        ...
        for (var i, n, a, s = 0, r = t.length - 1; r >= s;) if (i = Math.floor((s + r) / 2), n = +t[i], a = +t[i - 1], e > n) s = i + 1;
        else {
            if (!(n > e)) return i;
        ...
        function a(e) {
            for (var i, n, a = [], s = 0, r = t._tasks.width.filter(function(t) {
                ...
                if (_ != n && void 0 !== n || o == r.length - 1) {
                    i = document.createElement("div"), i.style.height = t.config.row_height * t._order.length + "px", i.style.cssFloat = "left", i.style.whiteSpace = "no-wrap", i.style.backgroundImage = "url(" + e[n || _] + ")";
                    var d = s;
                ...
                add: function(e) {
                    if (e && this.tempCollection.push(e), this.container()) for (var n = this.container(), a = this.tempCollection, s = 0; s < a.length; s++) {
                        var e = a[s],
                            ...
                            o = e.id,
                            _ = e.topmost;
                        if (!r.parentNode) if (_) n.appendChild(r);
                        else {
        ...
        return t.$task_data
    }), t.addTaskLayer = t._add_generic_layer(t._task_layers, [t._filter_task, t._is_chart_visible].concat(t._get_task_filters())), t.removeTaskLayer = function(e) {
        ...
        this._load_url = e, this.assert(arguments.length, "Invalid load arguments"), this.callEvent("onLoadStart", []);
        var a = "json",
            s = null;
        ...
        get_calendar: function() {
            return t.config.worktimes || (t.config.worktimes = {}), t.config.worktimes.global || (t.config.worktimes.global = this.default_calendar()), t.config.worktimes.global
        },
        unset_time: function(t) {
            if (t) {
                var e = this._timestamp(t);
                null !== e && delete this.get_calendar().dates[e]
            } else this.get_calendar().hours = [];
        ...
        global: t._working_time_helper.default_calendar()
        ...
        this.setParent(t, i), this._sync_parent(t), this._replace_branch_child(e, t.id), this.isTaskExists(i) || i == this.config.root_id ? this._add_branch(t) : delete this._branches[t.id], t.$level = this.calculateTaskLevel(t), this.eachTask(function(t) {
        ...
        e.start_date = e.start_date || t._default_task_date(e, this.getParent(e)), e.duration = e.duration || this.config.duration_step, e.end_date = e.end_date || this.calculateEndDate(e.start_date, e.duration);
        ...
        for (var e = "", i = 0; i < t.length; i++) {
            ...
            if (n) {
                ...
                var a = t[i].hidden ? " style='display:none'" : "",
                    s = "";
                t[i].button && (s = "<div class='gantt_custom_button' index='" + i + "'><div class='gantt_custom_button_" + t[i].button + "'></div><div>" + this.locale.labels["button_" + t[i].button] + "</div></div>"), this.config.wide_form && (e += "<div class='gantt_wrap_section' " + a + ">"), e += "<div id='" + t[i].id + "' class='gantt_cal_lsection'>" + s + this.locale.labels["section_" + t[i].name] + "</div>" + n.render.call(this, t[i]), e += "</div>"
            }
        }
        return e
        ...
        for (var i = this._get_typed_lightbox_config(), n = 0; n < i.length; n++) {
            ...
            if (s) {
                ...
                else if ("object" == typeof o) for (var _ in o) o[_] && (e[o[_]] = r[_])
            }
        }
        return e
        ...
        return n
    }, t.form_blocks.duration_optional = t._extend_to_optional(t.form_blocks.duration), t.form_blocks.time_optional = t._extend_to_optional(t.form_blocks.time), t.dataProcessor = function(e) {
            ...
            if (e) {
                ...
                var n = this,
                    a = function(t) {
                        var a = [];
                        if (i) a.push(i);
                        else if (e) for (var s in e) a.push(s);
        ...
        afterUpdateCallback: function(t, e, i, n) {
            ...
            switch (i) {
                ...
                case "delete":
                case "deleted":
                    return this.obj.setUserData(t, this.action_param, "true_deleted"), this.obj[this._methods[3]](t), delete this._in_progress[a], this.callEvent("onAfterUpdate", [t, i, e, n])
            }
        ...
        this._init_html_area(e), this._set_sizes(), this._clear_renderers(), this.resetLightbox(), this._update_flags(), this._init_touch_events(), this._init_templates(), this._init_grid(), this._init_tasks(), this._set_scroll_events(), t.event(this.$container, "click", this._on_click), t.event(this.$container, "dblclick", this._on_dblclick), t.event(this.$container, "mousemove", this._on_mousemove), t.event(this.$container, "contextmenu", this._on_contextmenu), this.callEvent("onGanttReady", []), this.render()
        ...
        1 * e == e && (this.$task.scrollLeft = e, this._save_scroll_state(e, void 0)), 1 * i == i && (this.$scroll_ver.scrollTop = i, this.$task_data.scrollTop = i, this.$grid_data.scrollTop = i, t.config.smart_rendering && this.$grid_data.scrollTop != i && (this.$grid_data.scrollTop = this.$task_data.scrollTop % t.config.row_height), this._save_scroll_state(void 0, this.$task_data.scrollTop));
        ...
        if (!(this._x < 20 || this._y < 20)) {
            ...
            t.x ? (this.$scroll_hor.style.display = "block", this.$scroll_hor.style.height = t.scroll_size + "px", this.$scroll_hor.style.width = t.x + "px", this.$scroll_hor.firstChild.style.width = t.x_inner + "px") : (this.$scroll_hor.style.display = "none", this.$scroll_hor.style.height = this.$scroll_hor.style.width = "0px"), t.y ? (this.$scroll_ver.style.display = "block", this.$scroll_ver.style.width = t.scroll_size + "px", this.$scroll_ver.style.height = t.y + "px", this.$scroll_ver.style.top = this.config.scale_height + "px", this.$scroll_ver.firstChild.style.height = t.y_inner + "px") : (this.$scroll_ver.style.display = "none", this.$scroll_ver.style.width = this.$scroll_ver.style.height = "0px")
        }
        ...
        this._adjust_scales(), this._skip_render = !1, e || this.render(), n && (this._dp.setUpdateMode(i), this._dp.setGanttMode("tasks"), this._dp.sendData(), this._dp.setGanttMode("links"), this._dp.sendData())
    }, t.env = {
        ...
        _call: function(e, i, n, a, s, r, o) {
            ...
            if (a && (_.onreadystatechange = function() {
                ...
                }), "GET" != e || this.cache || (i += (i.indexOf("?") >= 0 ? "&" : "?") + "dhxr" + (new Date).getTime() + "=1"), _.open(e, i, a), o) for (var l in o) _.setRequestHeader(l, o[l]);
        ...
        function i(i) {
            if (g) {
                ...
                return t.message.keyboard && ((13 == n || 32 == n) && e(g, !0), 27 == n && e(g, !1)), i.preventDefault && i.preventDefault(), !(i.cancelBubble = !0)
            }
        }
        function n(t) {
        ...
        function s(t) {
            f.area || (f.area = document.createElement("DIV"), f.area.className = "gantt_message_area dhtmlx_message_area", f.area.style[f.position] = "5px", document.body.appendChild(f.area)), f.hide(t.id);
            var e = document.createElement("DIV");
            return e.innerHTML = "<div>" + t.text + "</div>", e.className = "gantt-info dhtmlx-info gantt-" + t.type + " dhtmlx-" + t.type, e.onclick = function() {
                f.hide(t.id), t = null
            }, "bottom" == f.position && f.area.firstChild ? f.area.insertBefore(e, f.area.firstChild) : f.area.appendChild(e), t.expire > 0 && (f.timers[t.id] = window.setTimeout(function() {
                f.hide(t.id)
            }, t.expire)), f.pull[t.id] = e, e = null, t.id
        }
        function r() {
        ...
        function o(i, n, s) {
            var o = document.createElement("DIV");
            o.className = " gantt_modal_box dhtmlx_modal_box gantt-" + i.type + " dhtmlx-" + i.type, o.setAttribute("dhxbox", 1);
            var _ = "";
            if (i.width && (o.style.width = i.width), i.height && (o.style.height = i.height), i.title && (_ += '<div class="gantt_popup_title dhtmlx_popup_title">' + i.title + "</div>"), _ += '<div class="gantt_popup_text dhtmlx_popup_text"><span>' + (i.content ? "" : i.text) + '</span></div><div  class="gantt_popup_controls dhtmlx_popup_controls">', n && (_ += a(r(i.ok, t.locale.labels.message_ok, "OK"), !0)), s && (_ += a(r(i.cancel, t.locale.labels.message_cancel, "Cancel"), !1)), i.buttons) for (var d = 0; d < i.buttons.length; d++) _ += a(i.buttons[d], d);
            if (_ += "</div>", o.innerHTML = _, i.content) {
                var l = i.content;
                "string" == typeof l && (l = document.getElementById(l)), "none" == l.style.display && (l.style.display = ""), o.childNodes[i.title ? 1 : 0].appendChild(l)
            }
        ...
        function _(e, a, s) {
            ...
            return "top" == e.position ? r.style.top = "-3px" : r.style.top = d + "px", r.style.left = _ + "px", r.onkeydown = i, r.focus(), e.hidden && t.modalbox.hide(r), r
        }
        function d(t) {
            return _(t, !0, !1)
        }
        ...
        this._gantt_touch_event_ready || (this._gantt_touch_event_ready = 1, t.event(t.$container, e[0], function(e) {
            ...
            if (!n(e)) {
                ...
                h = setTimeout(function() {
                    var e = t.locate(l);
                    !e || t._locate_css(l, "gantt_link_control") || t._locate_css(l, "gantt_grid_data") || (t._tasks_dnd.on_mouse_down(l), t._tasks_dnd.drag && t._tasks_dnd.drag.start_drag && (s(e), t._tasks_dnd._start_dnd(l), t._touch_drag = !0, t.refreshTask(e), t._touch_feedback())), h = null
                }, t.config.touch_drag)
            }
