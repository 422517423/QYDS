...
function getList() {
    axse("/erp_produce_line/getAll.json", {}, successFn, errorFn);
}
    ...
    if (data.resultCode == '00') {
        ...
        if (array != null) {
            for (var i = 0; i < array.length; i++) {
                var data = new Array();
                //console.log(array[]);
                data[0] = array[i].lineCode;
                data[1] = array[i].lineNameEn;
                data[2] = array[i].lineNameCn;
