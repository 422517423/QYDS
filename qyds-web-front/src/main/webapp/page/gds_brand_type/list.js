        ...
        init : function(){
            ...
            function successFn() {
                ...
                $('#addBtn').on('click',function(){
                    ...
                    $('#content').load('gds_brand_type/edit.html');
                ...
                $('#delBtn').on('click',function(){
                    ...
                    showConfirm('确认删除该分类吗?',function(){
                        ajaxPost('/gds_brand_type/delete.json',
                ...
                $('#upBtn').on('click',function(){
                    ...
                    ajaxPost('/gds_brand_type/resort.json',
                ...
                $('#downBtn').on('click',function(){
                    ...
                    data.push({goodsTypeId: node.goodsTypeId,sort: selectNode[0].sort});
                    console.log("data === " +data);
                    ajaxPost('/gds_brand_type/resort.json',{'data':JSON.stringify(data)},function (data) {
                        if($.type(data) == 'string' && data != ''){
                            data = $.parseJSON(data);
                        }
