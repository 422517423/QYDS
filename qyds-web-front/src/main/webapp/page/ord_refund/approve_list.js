    ...
    return {
        init: function () {
            oTable = $('#ord_master_table').dataTable({
                ...
                "aoColumns": [
                    ...
                    { "mData": "applyComment",'bSortable': false },
                    {
                        ...
                        "fnRender": function ( oObj ) {
                            ...
                            str += '<a class="approve" href="#" style="margin-left:5px;" onclick=approve("' + oObj.aData.rexOrderId + '")>退款审批</a>';
                            return str;
                        }
                    }
                ...
                "bProcessing": false,
                "bServerSide": true,
                "sAjaxSource": "../ord_refund/approveList.json",
...
function edit(id){
    ...
    sessionStorage.setItem("backPage","ord_refund/approve_list.html");
...
function approve(id){
    ...
    $('#content').load('ord_refund/approve.html');
}
