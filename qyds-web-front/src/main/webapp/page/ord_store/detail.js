...
//退回到列表画面
function back() {
    $('#content').load('ord_store/list.html');
}
...
function initSubGoodsTable() {
    var tableOption = {
        ...
        "aoColumns": [
            ...
            {"mData": "actionName"},
            {
                "mData": "dispatchStatus",
                "fnRender": function (rowData) {
                    if (rowData.aData.dispatchStatus == null) {
                        return "";
                    } else if (rowData.aData.dispatchStatus == "0"){
                        return "未分派";
                    } else if (rowData.aData.dispatchStatus == "1"){
                        return "已分派";
                    } else if (rowData.aData.dispatchStatus == "2"){
                        return "拒绝接受";
                    } else if (rowData.aData.dispatchStatus == "3"){
                        return "接受分派";
                    } else {
                        return "";
                    }
