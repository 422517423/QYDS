...
function initTable() {
    var tableOption = {
        ...
        "fnServerParams": function (aoData) {
            ...
            // 31：退货中
            aoData.push({"name": "orderStatus", "value": "31"});
            // 31：退货已收货
            aoData.push({"name": "deliverStatus", "value": "31"});
            // 30：退款中
            aoData.push({"name": "payStatus", "value": "30"});
        },
        "aoColumns": [
            {"mData": "orderCode"},
...
function order_edit(obj) {
    ...
    $('#content').load('ord_return_goods/refund.html');
}